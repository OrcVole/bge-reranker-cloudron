...
- **Screenshots**: *`screenshots/docs.png` (the Swagger API docs, showing `/rerank`), `screenshots/app-tile.png` (the icon in the dashboard), and `screenshots/overview.png` (a branded explainer card)*
